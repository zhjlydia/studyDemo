! function () {
    ...
    function e(i) {
        this.canvas = i, this.ctx = this.canvas.getContext("2d"), this.audio = NE("#audio")[0], this.imgList = [{
            ...
            link: "http://img3.cache.netease.com/f2e/ent/ent_painting2016/images/4.jpg?1520",
            limitMax: .22,
            limitMin: .15,
            imgW: "1875",
            imgH: "3015",
            ...
            link: "http://img3.cache.netease.com/f2e/ent/ent_painting2016/images/5.jpg?1200",
            limitMax: .18,
            limitMin: .123,
            imgW: "1875",
            imgH: "3015",
            ...
            link: "http://img3.cache.netease.com/f2e/ent/ent_painting2016/images/6.jpg?1200",
            imgW: "1875",
            imgH: "3015",
            areaW: "187",
            areaH: "300",
    ...
    /micromessenger/.test(navigator.userAgent.toLocaleLowerCase()) && NE(".share_btn").hide(), document.addEventListener("touchmove", i, !1), e.prototype.initCanvas = function () {
        this.w = window.innerWidth, this.h = window.innerHeight, this.canvas.setAttribute("width", window.innerWidth), this.canvas.setAttribute("height", window.innerHeight)
    ...
    }, e.prototype.drawImgOversize = function (i, e, t, a, n, m, g, s) {
        this.ctx.drawImage(i, m - (a / s - a) * (m / (e - a)), g - (n / s - n) * (g / (t - n)), a / s, n / s, 0, 0, 750, 1206)
    }, e.prototype.drawImgMinisize = function (i, e, t, a, n, m, g, s, r, o) {
        this.ctx.drawImage(i, 0, 0, e, t, (m / o - m) * (s / (a - m)) * o * 750 / m, (g / o - g) * (r / (n - g)) * o * 1206 / g, 750 * o, 1206 * o)
    };
